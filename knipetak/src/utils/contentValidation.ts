...
export function containsProhibitedWords(text: string): { valid: boolean; reason?: string } {
...
export function calculatePasswordStrength(password: string): { strength: number; message: string } {
    let strength = 0;
    const messages = [
        'Veldig svakt',
        'Svakt',
